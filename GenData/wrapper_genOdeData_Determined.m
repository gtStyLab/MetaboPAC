function datasetFileName = wrapper_genOdeData_Determined(paramSetNum,dataDir)
...
% combination of CoV and lo-res nT values. 
    ...
    datasetFileName = sprintf('Determined_k-%02d_hiRes.mat',paramSetNum);
    ...
    try
        paramsVec = getParamsVecNum_Determined(paramSetNum);
    ...
    if ~paramErrorCatch
        ...
        odeDataset.nT = nT;
        odeDataset.paramsVec = paramsVec(1:8);
        odeDataset.x0 = paramsVec(9:12);
...
% %         [odeDataset.timeVec, odeDataset.concMatrix, odeDataset.fluxMatrix] = solveODE(odeDataset.tStart,odeDataset.tEnd,odeDataset.nT,odeDataset.x0,odeDataset.paramsVec);
        [odeDataset.timeVec, odeDataset.concMatrix, odeDataset.fluxMatrix] = solveOdeMmDetermined(odeDataset.tStart,odeDataset.tEnd,odeDataset.nT,odeDataset.x0,odeDataset.paramsVec);
