...
function v = calcFluxes(~,x,params)
    ...
    v(1,1) = params(62)*(params(63)-x(17));

    %Glucose uptake
    v(2,1) = (params(1)/params(61))*(x(17)/params(2))/(1 + x(17)/params(2) + ((params(3)*x(17)/params(2) + 1)/(params(3)*x(2)/params(2) + 1)) * (1 + x(2)/params(2) + x(8)/params(4) + (x(2)*x(8))/(params(2)*params(5))))...
        - (params(6)/params(61))*(x(2)/params(2))/(1 + x(2)/params(2) + ((params(3)*x(2)/params(2) + 1)/(params(3)*x(17)/params(2) + 1)) * (1 + x(2)/params(2)) + x(8)/params(4) + (x(2)*x(8))/(params(2)*params(5)));
    ...
    %Ethanol out
    v(13,1) = (params(48)/params(61))*(x(4) - x(15));

    %Ethanol flow
    v(14,1) = params(62)*x(15);

    %Glycerol synthesis
    v(15,1) = (params(49)*x(7))/(params(50)*(1 + (params(51)/x(22))*(1 + x(9)/params(52))) + x(7)*(1 + (params(53)/x(22))*(1 + x(9)/params(52))));

    %Glycerol out
    v(16,1) = (params(54)/params(61))*(x(3) - x(16));

    %Glycerol flow
    v(17,1) = params(62)*x(16);

    %Acetaldehyde out
    v(18,1) = (params(55)/params(61))*(x(1) - x(10));

    %Acetaldehyde flow
    v(19,1) = params(62)*x(10);

    %Cyanide-Acetaldehyde flow
    v(20,1) = params(56)*x(10)*x(13);

    %Cyanide flow
    v(21,1) = params(62)*(params(64) - x(13));
