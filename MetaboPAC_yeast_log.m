function [absolute_concMatrix predicted_responseFactors] = MetaboPAC_yeast_log(rep,percKnownKinetics)

% Set up initial information about system
modelInfo_hynne
load('hynne_k-01_hiRes.mat');
...
save(sprintf('yeast_MetaboPAC_log_percKnownKinetics-%03d_rep-%03d.mat',percKnownKinetics,rep));
end
