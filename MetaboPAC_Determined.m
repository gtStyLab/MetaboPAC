function [absolute_concMatrix predicted_responseFactors] = MetaboPAC_Determined(rep,percKnownKinetics)

% Set up initial information about system
modelInfo_Determined
load('Determined_k-01_hiRes.mat');
...
save(sprintf('Determined_MetaboPAC_percKnownKinetics-%03d_rep-%03d.mat',percKnownKinetics,rep));
end
