% Plot results for noisy yeast system.
% Figure 6 and Figure S8
...
for nt = [50 15]
    for cov = [5 15]
        ...
        for percKnownFlux = [0 20 40 60 80 100]
            run_count = 1;
            for run = 1:100
                fileName = sprintf('results/yeast_MetaboPAC_nT-%03d_cov-%02d_percKnownKinetics-%03d_rep-%03d.mat',nt,cov,percKnownFlux,run);
