...
% Figure 3, Figure S4, and Figure S5
...
for log2_error = [1.1 1.3 1.5]
    ...
    for percKnownFlux = [0 20 40 60 80 100]
        run_count = 1;
        for run = 1:100
            fileName = sprintf('results/yeast_MetaboPAC_percKnownKinetics-%03d_rep-%03d.mat',percKnownFlux,run);
...
for log2_error = [1.1 1.3 1.5]
    ...
    for percKnownFlux = [0 20 40 60 80 100]
        run_count = 1;
        for run = 1:100
            fileName = sprintf('results/ecoli_MetaboPAC_percKnownKinetics-%03d_rep-%03d.mat',percKnownFlux,run);
